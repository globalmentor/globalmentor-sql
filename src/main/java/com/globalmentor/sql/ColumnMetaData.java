...
public class ColumnMetaData extends DefaultComparableNamed<String> {
	...
	public enum Columns {
		 ...
		 * <dl>
		 * <dt><code>columnNoNulls</code></dt>
		 * <dd>might not allow NULL values</dd>
		 * <dt><code>columnNullable</code></dt>
		 * <dd>definitely allows NULL values</dd>
		 * <dt><code>columnNullableUnknown</code></dt>
		 * <dd>nullability unknown</dd>
		 * </dl>
		 */
		NULLABLE,
		...
		ORDINAL_POSITION,
		/**
		 * Whether the column is nullable (String); "NO" means column definitely does not allow NULL values; "YES" means the column might allow NULL values. An
		...
		SCOPE_TABLE,
		/**
		 * Source type of a distinct type or user-generated Ref type, SQL type from {@link Types} (short); <code>null</code> if DATA_TYPE isn't DISTINCT or
		 * user-generated REF.
		 */
		SOURCE_DATA_TYPE
	}
