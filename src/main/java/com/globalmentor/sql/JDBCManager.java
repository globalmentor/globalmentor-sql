 ...
 * <p>
 * The database properties expected are the following:
 * </p>
 * <dl>
 * <dt><code>driver</code></dt>
 * <dd>The class name of the database driver.</dd>
 * <dt><code>user</code></dt>
 * <dd>The user name for connecting to the database.</dd>
 * <dt><code>password</code></dt>
 * <dd>The user password for connecting to the database.</dd>
 * <dt><code>url</code></dt>
 * <dd>The URL for connecting to the database.</dd>
 * </dl>
 * <p>
 * The URL accepts the following replacement parameters:
 * </p>
 * <dl>
 * <dt>{0}</dt>
 * <dd>The supplied database directory, or the user directory if none was specified when this class was created.</dd>
 * </dl>
...
public class JDBCManager {
	 ...
	 * @param properties The JDBC properties that contain information such as driver and username.
	 */
	 ...
	 * @param properties The JDBC properties that contain information such as driver and username.
	 * @param directory The directory in which to store the database (if the properties files provides a replacement parameter), or <code>null</code> if the user
	 *          directory should be used for the directory.
	 */
