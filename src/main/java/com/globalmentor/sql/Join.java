...
public class Join {
	...
	protected NameValuePair<Column<?>, Column<?>>[] getJoins() {
		return joins;
	}

	/**
	 * Creates an expression joining columns.
	 * @param joins The column-column pairs to join, where the name column belongs to the joining table and the value column belongs to the table being joined.
	 */
